...
public class NERDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serializedClassifier = "/Users/petergershkovich/Downloads/stanford-ner-2015-01-30/classifiers/english.all.3class.distsim.crf.ser.gz";
    ...
    */
        ...
        String fileName = "/Users/petergershkovich/Documents/Custom LIS/JPatholInform5120-3451224_093512.txt";
...
//            }
            ...
            System.out.println("---");
            List<List<CoreLabel>> out = classifier.classifyFile(fileName);
            for (List<CoreLabel> sentence : out) {
                for (CoreLabel word : sentence) {

                    if ("PERSON".equalsIgnoreCase(word.get(CoreAnnotations.AnswerAnnotation.class)))
                    {
                        System.out.print(", ");
                        System.out.print(word.word().replaceAll("\\d","; "));
                    }
                }
                System.out.println();
            }
...
//            classifier.classifyAndWriteAnswersKBest(fileName, 10, readerAndWriter);
//
//            System.out.println("---");
//            System.out.println("Per-token marginalized probabilities");
//            classifier.printProbs(fileName, readerAndWriter);
