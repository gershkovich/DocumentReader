...
public final class Word2Forest
{
    Writer _out;
    HWPFDocument _doc;

    @SuppressWarnings("unused")
    public Word2Forest(HWPFDocument doc, OutputStream stream) throws IOException
    {
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            new Word2Forest(new HWPFDocument(new FileInputStream("/Users/petergershkovich/Downloads/LibraryVariant.doc")), out);
            out.close();
        }
        catch (Exception t)
        {
